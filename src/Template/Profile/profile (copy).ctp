    ...
    <div class="form-group">
      <div class="col-sm-12">
        ...
        <i class="fas fa-user"></i>
            <?php echo $this->Form->input('name',array('class'=>'form-control','placeholder'=>'Company Name','required'=>true,'label' =>false,'type'=>'text','value'=>$profile['name'])); ?>
      </div>
    </div>
    <div class="form-group">
      <div class="col-sm-12">
      <i class="fas fa-briefcase"></i>
 <?php echo $this->Form->input('comp_name',array('class'=>'form-control','placeholder'=>'Display Name','required'=>true,'label' =>false,'type'=>'text','value'=>$profile['comp_name'])); ?>      </div>
    </div>
    <div class="form-group">
      <div class="col-sm-12">
