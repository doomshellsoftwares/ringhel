 <div class="content-wrapper">
   <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo SITE_URL; ?>admin/internal">internal User</a></li>
    </ol> 
  ...
  <section class="content">
      ...
      <div class="col-xs-12">    
        <div class="box">
          <div class="box-header">
            ...
            <a href="<?php echo SITE_URL; ?>admin/internal/add">
    ...
    foreach($users as $intusr){//pr($intusr);die;
      ...
      <tr>
        ...
        <td><?php if(isset($intusr['language']['short_name'])){ echo ucfirst($intusr['language']['short_name']);}else{ echo 'N/A'; } ?></td>
