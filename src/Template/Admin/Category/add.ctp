<div class="content-wrapper">
				...
				<div class="box box-info">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<?php echo $this->Form->input('parent_id', array('class' => 'form-control','label'=>false,'empty'=>'Main Category','options' => $names)); ?>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-6 input_fields_wrap">
								<?php echo $this->Form->input('name', array('class' => 'form-control','type'=>'text','required','label'=>false,'placeholder'=>'Enter Subcategory Name')); ?>
							</div>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<div class="form-group"><div class="col-sm-10"> <?php echo $this->Form->input('name[]', array('class' => 'form-control','required','label'=>false,'placeholder'=>'Enter Subcategory Name')); ?></div><a href="#" class="remove_field"><i style="font-size: 26px; padding-top: 4px;color: #3c8dbc;" class="fa fa-minus-circle"></i></a></div>'); //add input box
        }
    });
