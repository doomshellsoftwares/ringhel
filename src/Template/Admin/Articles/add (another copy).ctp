    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
         ...
         <div class="box-body">
          ...
          <div class="form-group">
           ...
           <div class="col-sm-3">
             <?php echo $this->Form->input('lang_id', array('class' => 'form-control','label'=>false,'placeholder'=>'Enter Company Name', 'required','type'=>'select','options'=>$language,'empty'=>'Select Language ')); ?> 
         ...
         <label for="inputEmail3" class="col-sm-2 control-label">Subcategory</label>
          ...
          <div class="col-sm-3">
           <?php 
           echo $this->Form->input('subcat_id', array('class' => 'form-control','empty'=>'Select Sub Categroy','id'=>'state','required','label'=>false)); ?>
       ...
       <div class="form-group">
        ...
        <div class="col-sm-3">
         <?php $sector=array('1'=>'Draft','2'=>'Published');
         echo $this->Form->input('sector', array('class' => 'form-control','selected','options'=>$sector,'required','label'=>false)); ?>
